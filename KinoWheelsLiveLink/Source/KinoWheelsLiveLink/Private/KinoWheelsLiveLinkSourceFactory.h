...
#include "KinoWheelsLiveLinkSourceFactory.generated.h"

class SKinoWheelsLiveLinkSourceEditor;

UCLASS()
class UKinoWheelsLiveLinkSourceFactory : public ULiveLinkSourceFactory
{
public:
